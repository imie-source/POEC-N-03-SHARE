...
@Named("french")
@French
public class FrenchFilmService implements FilmServiceInterface {
	...
	public List<FilmDTO> getFilms() {
		...
		filmDTO2.setId(2);
		filmDTO2.setTitre("La citée de la peur");
		...
		filmDTO3.setId(3);
		filmDTO3.setTitre("Les Bronzés 2");
		filmDTO3.setDuree(120);
		filmDTO3.setGenre("humour douteux");
